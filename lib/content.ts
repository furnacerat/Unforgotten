export const navItems = [
  ...
  { href: "/chapter-01", label: "Chapter 01" },
  { href: "/shop-preview", label: "The Collection" },
...
export const products = [
  {
    ...
    href: "/products/the-shepherd-hoodie",
  },
  {
    name: "The One Tee",
    description:
